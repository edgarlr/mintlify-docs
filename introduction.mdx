...
import { CardGroup, Card } from './external'
...
<img alt="Hero Light" classname="block dark:hidden" src="https://github.com/edgarlr/mintlify-docs/blob/main//images/hero-light.png?raw=true" />

<img alt="Hero Dark" classname="hidden dark:block" src="https://github.com/edgarlr/mintlify-docs/blob/main//images/hero-dark.png?raw=true" />
