...
Follow these steps to install and run Mintlify on your operating system: (TEST-21)
...
<Frame>
  <img src="https://github.com/edgarlr/mintlify-docs/blob/main//images/checks-passed.png?raw=true" />
</Frame>
