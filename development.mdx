...
Follow these steps to install and run Mintlify on your operating system sas:
...
<Frame>
  <img src="https://github.com/edgarlr/mintlify-docs/blob/branch-4//images/checks-passed.png?raw=true" style={{ borderRadius: '0.5rem' }} />
</Frame>
