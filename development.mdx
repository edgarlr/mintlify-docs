...
Follow these steps toaosidjaosid aosidjaosidinstall and run Mintlify on your operating system: (TEST-27)
...
<Frame>
  ![](https://github.com/edgarlr/mintlify-docs/blob/main//images/checks-passed.png?raw=true)
</Frame>
